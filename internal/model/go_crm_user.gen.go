...
type GoCrmUser struct {
	...
	UsrCreatedAt     int32  `gorm:"column:usr_created_at;not null;comment:Created Time" json:"usr_created_at"`              // Created Time
	UsrUpdatedAt     int32  `gorm:"column:usr_updated_at;not null;comment:Updated Time" json:"usr_updated_at"`              // Updated Time
	UsrCreateIPAt    string `gorm:"column:usr_create_ip_at;not null;comment:Created IP" json:"usr_create_ip_at"`            // Created IP
	...
	UsrStatus        bool   `gorm:"column:usr_status;not null;comment:Status" json:"usr_status"`                            // Status
}
