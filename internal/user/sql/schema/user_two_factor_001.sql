...
CREATE TABLE IF NOT EXISTS `user_two_factor_001` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='user_two_factor_001';
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS `user_two_factor_001`;
-- +goose StatementEnd
